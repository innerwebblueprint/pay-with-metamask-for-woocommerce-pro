...
if (!class_exists('cpmwp_TRANSACTION_TABLE')) {
    class cpmwp_TRANSACTION_TABLE
    {
        ...
        public static function cpmwp_transaction_table()
        {
            $list_table = new cpmwp_metamask_list();
            echo '<div class="wrap"><h2>' . __("Crypto Transactions", "cpmwp") . '</h2>';
