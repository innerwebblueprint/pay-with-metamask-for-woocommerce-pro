...
if ( ! class_exists( 'CSF_Setup' ) ) {
  class CSF_Setup {
    ...
    public function __construct() {
      ...
      add_action( 'after_setup_theme', array( 'CSF_Setup', 'setup' ) );
      add_action( 'init', array( 'CSF_Setup', 'setup' ) );
      add_action( 'switch_theme', array( 'CSF_Setup', 'setup' ) );
      add_action( 'admin_enqueue_scripts', array( 'CSF_Setup', 'add_admin_enqueue_scripts' ) );
      add_action( 'wp_enqueue_scripts', array( 'CSF_Setup', 'add_typography_enqueue_styles' ), 80 );
      add_action( 'wp_head', array( 'CSF_Setup', 'add_custom_css' ), 80 );
      add_filter( 'admin_body_class', array( 'CSF_Setup', 'add_admin_body_class' ) );
