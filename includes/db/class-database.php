...
class cpmwp_database {
	...
	public function cpmwp_get_data() {
		global $wpdb;
	...
	// public function cpmwp_insert_data($coins_data)
	// {
	...
	public function cpmwp_insert_data( $transactions ) {
	...
	public function cpmwp_get_data_of_pending_transaction() {
		global $wpdb;
	 ...
	 */
	public function cpmwp_get_tx_order_id( $tx_id ) {
		global $wpdb;
